...
createMenuItem('Bacon Cheese Burger', '7', 'Lunch');
createMenuItem('Turkey Wrap', '5', 'Lunch');
createMenuItem('Steak and Eggs', '11', 'Breakfast');
createMenuItem('Country Fried Steak', '10', 'Dinner');
...
*/
reviews.push({name: 'Spencer', rating: 4, feedback: 'Is this the Krusty Krab?'})
console.log(reviews);
